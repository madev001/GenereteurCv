...
public class SFormation {
	...
	public void AjoutFormation(WebDriver driver,String intitule,String ville,String etab,String moisDebut,String anneeDebut,String moisFin,String anneeFin,String tiny)
	{
			driver.findElement(By.className("add")).click();
			driver.findElement(By.id("Intitule")).sendKeys(intitule);
